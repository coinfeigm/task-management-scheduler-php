 ...
 */
 ;(function() {
	...
	$.fn.glDatePicker.defaults =
	{
		...
		onMouseEnter: function(el, cell, date, data) {},
							...
							if(!isSelectable ||
								...
								cell
									...
									.mouseenter(function(e) {
										...
										// Call callback
										options.onMouseEnter(el, cell, hoverData.date, hoverData.data);
									})
									.mouseleave(function(e) {
										...
										// Call callback
										options.onMouseLeave(el, cell, hoverData.date, hoverData.data);
									})
									.click(function(e) {
										...
										// Call callback
										if (options.firstDate._val().month == firstDateMonth) {
